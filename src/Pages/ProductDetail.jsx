...
const ProductDetail = () => {
    ...
    // Loading
    const [loadAdd, setLoadAdd] = useState(null);
    ...
    const handleAddToCart = async (data) => {
        try {
            if (currentUser) {
                ...
                setLoadAdd(false);
                if (setDoc) {
                    toast.success("Add to cart succuessfully");
                }
            } else {
    ...
    const prevSlide = () => {
        setCurrentIndex((curr) =>
            curr === 0 ? data.img.length - 1 : curr - 1
        );
    };
    const nextSlide = () => {
        setCurrentIndex((curr) =>
            curr === data.img.length - 1 ? 0 : curr + 1
        );
    };
    ...
    return (
        <div className="">
            ...
            {isLogInToRate && (
                <div className="overlay">
                    <div className="popup w-[550px] bg-white rounded-xl p-7 flex flex-col justify-between relative">
                        <XMarkIcon
                            className="size-[30px] absolute right-[15px] top-[15px] hover:cursor-pointer"
                        ...
                        <div className="">
                            ...
                            <p className="py-7 text-[20px] font-normal text-center">
                                If you want to rate this product you need to log
                                in your account
                            </p>
                        </div>
                        <div className="flex items-center justify-end gap-4">
                ...
                <div className="overlay">
                    <div className="popup w-[550px] bg-white rounded-xl p-7 flex flex-col justify-between relative">
                        ...
                        <div className="">
                            ...
                            <p className="py-7 text-[20px] font-normal text-center">
                                If you wanna add this product in your cart you
                                need to log in your account
                            </p>
                        </div>
                        <div className="flex items-center justify-end gap-4">
                            <button
                ...
                <div className="overlay">
                    <div className="popup w-[550px] bg-white rounded-xl p-7 flex flex-col justify-between relative">
                        ...
                        <div className="">
                            ...
                            <p className="py-7 text-[20px] font-normal text-center">
                                If you wanna order this product in your cart you
                                need to log in your account
                            </p>
                        </div>
                        <div className="flex items-center justify-end gap-4">
            ...
            <div className="px-[135px]">
                ...
                <div className="pt-[80px] grid grid-cols-3 gap-[40px] ">
                    <div className=" gap-[30px] col-span-2 ">
                        <div
                            className={`bg-[#f5f5f5] h-[75%] flex items-center justify-center relative overflow-hidden `}
                        >
                            <div className="flex items-center w-full h-full row-span-2 overflow-hidden">
                                {data.img.map((img, index) => {
                                    return (
                                        <div
                                            className="flex items-center justify-center flex-shrink-0 w-full h-full transition-all duration-300 ease"
                                            key={index}
                                            style={{
                            ...
                            <button
                                className="absolute left-[20px] top-[50%] size-[60px] rounded-full bg-gray-300 flex items-center justify-center translate-y-[-50%] hover:cursor-pointer"
                                onClick={prevSlide}
                            ...
                            <button
                                className="absolute right-[20px] top-[50%] size-[60px] rounded-full bg-gray-300 flex items-center justify-center translate-y-[-50%] hover:cursor-pointer"
                                onClick={nextSlide}
                                disabled={
                                    currentIndex === data.img.length - 1
                                        ? true
                                        : false
                                }
                            >
                                <ChevronRightIcon className="size-[30px]" />
                            </button>
                        </div>
                        <div className="border-2 border-[gray-500] mt-7  rounded">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[28px] font-medium leading-[35px] tracking-[0.72px]">
                            {data.name}
                        </span>
                        ...
                        <div className="flex items-center gap-2 pb-2 pt-7">
                            <span className="text-[32px] text-[#e30019] font-semibold leading-[24px] tracking-[0.92px]">
                                {`$${data.newPrice}`}
                            </span>
                            <span
                                className={`text-[20px] text-[#343537] font-normal leading-[24px] tracking-[0.72px] opacity-50 line-through ${
                        ...
                        {data.cate === "laptop" ? (
                            <div className="p-4 border-2 border-[#c9c7c7] rounded">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center border w-fit border-black rounded-s h-[44px] rounded-e px-2">
                                <div
                            ...
                            <div className="flex items-center justify-between gap-3 py-4">
                                <button
                                    className="flex items-center justify-center border-2 border-black rounded  w-full py-[10px] text-[16px] font-medium leading-[24px]"
                                    onClick={() => {
                                        if (data.cate === "laptop") {
                                            handleAddToCart({
                                                id: data.id,
                                                ...
                                                infomation: {
                                                    ...
                                                    cpu: data.infomation.cpu,
                                                    hardDrive:
                                                        data.infomation
                                                            .hardDrive,
                                                    hz: data.infomation.hz,
                                                    inch: data.infomation.inch,
                                                    pin: data.infomation.pin,
                                                    ram: data.infomation.ram,
                                                    resolution:
                                                        data.infomation
                                                            .resolution,
                                                    type: data.infomation.type,
                                                    weight: data.infomation
                                                        .weight,
                                                },
                                                sales: data.sales,
                                                quantity: count,
                                ...
                                >
                                    {loadAdd ? (
                                        <div className="w-[89px] flex items-center justify-center h-[24px]">
                                ...
                                <button
                                    className="bg-[#DB4444] rounded w-full flex items-center justify-center text-white  py-[12px] text-[16px] font-medium leading-[24px]"
                                    onClick={() =>
                                        handleBuyNow(
                                            data,
                                            count,
                        ...
                        <div className="flex items-center gap-3 py-[30px]">
                            <span className="text-[28px] font-semibold leading-[21px]">
                                Total:
                            </span>
                ...
                <div className="grid grid-cols-3 py-[100px]">
                    <div className="border-2 border-gray-300 rounded-lg  col-span-2 p-[25px]">
                        ...
                        <div className="grid grid-cols-2 gap-4 py-7">
                            <button
                                className={`flex items-center justify-center py-3 border-2 border-black rounded-md ${
                                    reviewsData.length === 0 ? "hidden" : "flex"
                                }`}
                                onClick={() =>
                                    navigate(
                                        `/${data.cate}/${data.name}/reviews`,
                                        {
                                            state: {
                                                productFind: data,
                                            },
                            ...
                            <button
                                className="flex items-center justify-center py-3 text-white bg-blue-500 rounded-md"
