                    ...
                    if (newPassword.match(confirmPassword)) {
                        ...
                        await updatePassword(currentUser, newPassword)
                            .then(() => {
                                ...
                                setTimeout(() => {
                                    toast.success(
                                        "Changes your password successfully!"
                                    );
                                }, 1200);
                                setTimeout(() => {
                        ...
                        toast.error(
                            "Confirm password not match your new password!"
                        );
                    }
                } else {
