...
const OrdersCompleted = () => {
  ...
  useEffect(() => {
    if (data) {
      setOrdersCompleted(data.filter((order) => order.status === "Completed"));
    }
  }, [data]);
  useEffect(() => {
    window.scrollTo(0, 0);
          ...
          <div className="grid grid-cols-4 pb-36">
            ...
            <div className="pb-[30px] px-[50px] col-span-3 ">
              <div className="flex items-center  justify-between text-[14px] leading-[21px] font-medium text-gray-400 pb-8">
                ...
                <button
                  className="flex items-center justify-center px-5 py-1  rounded-2xl border-2 border-gray-400"
...
export default memo(OrdersCompleted);
